...
# Load GADM
country_map <- readRDS(file.path(dataPath, "Data\\Processed\\MWI\\GADM_maps/GADM_2.8_MWI_adm1.rds"))
...
country_map_df <- country_map@data %>%
  dplyr::select(ID = OBJECTID, adm1 = NAME_1)
...
# Save data
write_csv(tot_pop_adm_2000, file.path(dataPath, "Data/Processed/MWI/Spatial_data/tot_pop_adm_2000_MWI.csv"))
