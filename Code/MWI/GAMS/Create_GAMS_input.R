...
### WRITE
wgdx(file.path(dataPath, paste0("Model/", iso3c_sel, "/Data/model_input_", iso3c_sel, "_2000.gdx")), 
     avail_gdx, deptots_gdx, icrops_gdx, produ_gdx, priors_gdx, c_set_gdx, cg_set_gdx,
