...
### LOAD ADM
adm2 <- readRDS(file.path(dataPath, "Data\\ZWE\\Processed\\Maps/GAUL_ZWE_adm2_2000.rds"))
adm0 <- readRDS(file.path(dataPath, "Data\\ZWE\\Processed\\Maps/GAUL_ZWE_adm0_2000.rds"))
