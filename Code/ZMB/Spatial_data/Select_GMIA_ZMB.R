...
### LLOAD ADM
adm2_map <- readRDS(file.path(dataPath, "Data\\ZMB\\Processed\\Maps/GAUL_ZMB_adm2_2000.rds"))
adm0_map <- readRDS(file.path(dataPath, "Data\\ZMB\\Processed\\Maps/GAUL_ZMB_adm0_2000.rds"))
...
# Save map
saveRDS(GMIA, file.path(dataPath, "Data/ZMB/Processed/Maps/GMIA_ZMB.rds"))
