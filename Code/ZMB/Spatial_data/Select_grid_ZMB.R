...
### LOAD GAUL MAPS
adm1 <- readRDS(file.path(dataPath, "Data/ZMB/Processed/Maps/GAUL_ZMB_adm1_2000.rds"))
...
# Write raster
saveRDS(grid, file.path(dataPath, "Data/ZMB/Processed/Maps/grid_r_ZMB.rds"))
...
# Write polygon
saveRDS(grid_py, file.path(dataPath, "Data/ZMB/Processed/Maps/grid_ZMB.rds"))


### APPROACH TO ADD BORDER CELLS #1
# Note that:
# 1. We need another version of adm0 that excludes lake ZMB => union adm1
...
adm0 <- readRDS(file.path(dataPath, "Data/ZMB/Processed/Maps/GAUL_ZMB_adm0_2000.rds"))
