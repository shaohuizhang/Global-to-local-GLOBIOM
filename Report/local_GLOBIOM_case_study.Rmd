...
Figure 2 depicts the land cover map for 2000 overlaid with the SIMU grid. Land cover is classified into eight categories, which include the six standard classes used by GLOBIOM [@check] and additional classes for Shadow and Clouds. Fortunately, with 0.3% and 0.2% these classes only form a small part of total area (Table 1). We decided to add the Cloud and Shadow areas to the Other land class. 
